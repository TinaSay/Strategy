...
$config = [
    ...
    'modules' => [
        ...
        'menu' => [
            'viewPath' => '@elfuvo/menu/views/backend',
            ...
            'menuItems' => [
                ...
                elfuvo\menu\common\NewsMenu::class,
            ],
        ],
        'review' => [
            'class' => \app\modules\review\Module::class,
            'viewPath' => '@app/modules/review/views/backend',
            'controllerNamespace' => 'app\modules\review\controllers\backend',
        ],
        'expert' => [
            'class' => app\modules\expert\Module::class,
            'viewPath' => '@app/modules/expert/views/backend',
            'controllerNamespace' => 'app\modules\expert\controllers\backend',
        ],
    ],
    'components' => [
        'view' => [
